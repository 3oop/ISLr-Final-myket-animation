...
ابتدا به صورت نمونه با یک انیمیشن شروع می کنیم

فیچرهایی رو استخراج می کنیم که خود سایت داده
...
#می توانیم به جای a1,a2,a3,a4 از این کد استفاده کنیم
