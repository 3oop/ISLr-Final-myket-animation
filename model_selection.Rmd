...
df_dummy <- dummyVars(~ ., data = df) %>% predict(df) %>% as.data.frame()
train_data_dummy <- df_dummy[train_idx, ]
valid_data_dummy <- df_dummy[valid_idx, ]
test_data_dummy  <- df_dummy[test_idx, ]
